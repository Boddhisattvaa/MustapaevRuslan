		...
		<table>
			...
			<tr>
				<td class="button">
					...
					<input type="image" src="images/order_end.png" alt="Завершить оформление заказа" onmouseover="this.src='images/order_end_active.png'" onmouseout="this.src='images/order_end.png'" />
				</td>
			</tr>
		</table>
	</form>
