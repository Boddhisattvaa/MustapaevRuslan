...
class ProductContent extends Modules {
	...
	protected function getContent() {
		...
		$this->meta_desc = "Описание и покупка товара ".$product_info["title"];
		$this->meta_key = mb_strtolower("описание товара ".$product_info["title"].", купить товар ".$product_info["title"]);
